...
class DashboardController extends GetxController {
  ...
  RxList<MemberModel> menus = RxList<MemberModel>([]);
  ...
  Stream<List<MemberModel>> getAllMenus() => collRefference.snapshots().map(
      (query) => query.docs.map((item) => MemberModel.fromMap(item)).toList());
